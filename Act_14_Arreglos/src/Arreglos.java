...
Crearemos una nueva lista de int ( Arreglo de 10), donde se almacenarán 10 número s aleatorios (utilizaremos la clase Random).
Por último, mostraremos los 10 números generados con el siguiente formato de texto. 
	...
	public static void main(String[] args) {
		// Creo el Array de Integers, colocando ya cada valor en su posicion he preferido hacerlo así es mas corto.
		 ...
		 for ( int contador = 0; contador < arreglo.length; contador++ )
			 //Pedidmos que imprima cada posición en una lista de dos columnas, lo que no consigo es q  imprima la primera posicion alineada
			 System.out.printf( " La posición es %2d y he almacenado el valor%3d\n ", contador, arreglo[ contador ] );
		
		 //Así sólo imprimiria la posición que le pida, vamos a probar con 12 que le supera las posiciones a ver si me captura el error 
